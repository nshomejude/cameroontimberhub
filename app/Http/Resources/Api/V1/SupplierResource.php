...
class SupplierResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'address' => $this->when(filled($this->address_line), fn () => $this->address_line),
            'latitude' => $this->when($this->latitude !== null && $this->longitude !== null, fn () => (float) $this->latitude),
            'longitude' => $this->when($this->latitude !== null && $this->longitude !== null, fn () => (float) $this->longitude),
