...
<div x-data="{
    ...
    <template x-teleport="body">
        <div x-show="open" x-cloak class="fixed inset-0 z-[60]">
            ...
            <div x-show="open"
                 class="bottom-sheet-panel absolute inset-x-0 bottom-0 max-h-[88vh] overflow-y-auto rounded-t-3xl bg-white shadow-2xl"
                ...
                @if ($title)
                    <h2 class="px-5 font-display text-lg font-semibold text-forest-900">{{ $title }}</h2>
                @endif
