<div class="rounded-2xl border border-dashed border-sand-300 bg-white p-10 text-center sm:p-14">
    ...
    <h2 class="mt-4 text-[1.125rem] font-bold text-ink">{{ __('messages.directory.empty_title') }}</h2>
    <p class="mt-2 text-[1.0625rem] text-ink-soft">{{ __('messages.directory.empty_body') }}</p>
