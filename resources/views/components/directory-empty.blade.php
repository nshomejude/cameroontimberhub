<div class="rounded-2xl border border-dashed border-sand-300 bg-white p-10 text-center sm:p-14">
    ...
    <h2 class="mt-4 text-[1.125rem] font-bold text-ink">No verified suppliers match these filters yet</h2>
    <p class="mt-2 text-[1.0625rem] text-ink-soft">Try broadening your search, or tell us what you need and we'll connect you.</p>
