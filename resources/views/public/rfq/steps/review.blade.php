@php
    ...
    $cell = 'px-3 py-2.5 text-[0.8125rem] text-ink dark:text-[#e4ddcf]';
    $head = 'px-3 py-2 text-left text-[0.6875rem] font-bold uppercase tracking-wide text-ink-soft dark:text-[#8f887b]';
@endphp
...
<div class="space-y-7">
    ...
    <section aria-labelledby="review-details" class="rounded-xl border border-sand-200 dark:border-[#3a352e]">
        <div class="flex items-baseline justify-between gap-3 border-b border-sand-200 px-4 py-3 dark:border-[#3a352e]">
            <h3 id="review-details" class="text-[0.9375rem] font-bold text-forest-950 dark:text-sand-100">RFQ information</h3>
            <a href="{{ route('rfq.step', ['step' => 'details']) }}" class="rounded text-[0.8125rem] font-semibold text-forest-700 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest-500 dark:text-forest-300">Edit<span class="sr-only"> RFQ information</span></a>
        </div>
        <dl class="grid gap-4 px-4 py-4 sm:grid-cols-3">
            <div>
                ...
                <dd class="mt-0.5 text-[0.875rem] font-semibold text-ink dark:text-[#e4ddcf]">{{ $details['title'] ?? '—' }}</dd>
            </div>
            <div>
                <dt class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Project name</dt>
                <dd class="mt-0.5 text-[0.875rem] text-ink dark:text-[#e4ddcf]">{{ ($details['project_name'] ?? null) ?: '—' }}</dd>
            </div>
            <div>
                <dt class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Response deadline</dt>
                <dd class="mt-0.5 text-[0.875rem] text-ink dark:text-[#e4ddcf]">
    ...
    <section aria-labelledby="review-products" class="rounded-xl border border-sand-200 dark:border-[#3a352e]">
        <div class="flex items-baseline justify-between gap-3 border-b border-sand-200 px-4 py-3 dark:border-[#3a352e]">
            <h3 id="review-products" class="text-[0.9375rem] font-bold text-forest-950 dark:text-sand-100">
            ...
            <a href="{{ route('rfq.step', ['step' => 'products']) }}" class="rounded text-[0.8125rem] font-semibold text-forest-700 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest-500 dark:text-forest-300">Edit<span class="sr-only"> products</span></a>
        </div>
    ...
    <section aria-labelledby="review-terms" class="rounded-xl border border-sand-200 dark:border-[#3a352e]">
        <div class="flex items-baseline justify-between gap-3 border-b border-sand-200 px-4 py-3 dark:border-[#3a352e]">
            <h3 id="review-terms" class="text-[0.9375rem] font-bold text-forest-950 dark:text-sand-100">Delivery &amp; terms</h3>
            <a href="{{ route('rfq.step', ['step' => 'delivery']) }}" class="rounded text-[0.8125rem] font-semibold text-forest-700 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest-500 dark:text-forest-300">Edit<span class="sr-only"> delivery and terms</span></a>
        </div>
        <dl class="grid gap-4 px-4 py-4 sm:grid-cols-4">
            <div>
                ...
                <dd class="mt-0.5 text-[0.875rem] font-semibold text-ink dark:text-[#e4ddcf]">{{ strtoupper($delivery['destination_country_code'] ?? '—') }}</dd>
            </div>
            <div>
                <dt class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Port / delivery point</dt>
                <dd class="mt-0.5 text-[0.875rem] text-ink dark:text-[#e4ddcf]">{{ ($delivery['shipping_port'] ?? null) ?: '—' }}</dd>
            </div>
            <div>
        ...
        <div class="border-t border-sand-200 px-4 py-4 dark:border-[#3a352e]">
            <h4 class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Requirement details</h4>
            <p class="mt-1 whitespace-pre-line text-[0.875rem] leading-relaxed text-ink dark:text-[#e4ddcf]">{{ $delivery['notes'] ?? '' }}</p>
        </div>
    </section>
    ...
    <section aria-labelledby="review-contact" class="rounded-xl border border-sand-200 dark:border-[#3a352e]">
        <div class="flex items-baseline justify-between gap-3 border-b border-sand-200 px-4 py-3 dark:border-[#3a352e]">
            <h3 id="review-contact" class="text-[0.9375rem] font-bold text-forest-950 dark:text-sand-100">Your details</h3>
            <a href="{{ route('rfq.step', ['step' => 'contact']) }}" class="rounded text-[0.8125rem] font-semibold text-forest-700 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest-500 dark:text-forest-300">Edit<span class="sr-only"> your details</span></a>
        </div>
        <dl class="grid gap-4 px-4 py-4 sm:grid-cols-4">
            <div>
                <dt class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Name</dt>
                <dd class="mt-0.5 text-[0.875rem] font-semibold text-ink dark:text-[#e4ddcf]">{{ $contact['buyer_name'] ?? '—' }}</dd>
            </div>
            <div>
                <dt class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Email</dt>
                <dd class="mt-0.5 break-all text-[0.875rem] text-ink dark:text-[#e4ddcf]">{{ $contact['buyer_email'] ?? '—' }}</dd>
            </div>
            <div>
                <dt class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Company</dt>
                <dd class="mt-0.5 text-[0.875rem] text-ink dark:text-[#e4ddcf]">{{ ($contact['buyer_company'] ?? null) ?: '—' }}</dd>
            </div>
            <div>
                <dt class="text-[0.6875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Country</dt>
                <dd class="mt-0.5 text-[0.875rem] text-ink dark:text-[#e4ddcf]">{{ strtoupper($contact['buyer_country_code'] ?? '—') }}</dd>
            </div>
        </dl>
    </section>
    ...
    <section aria-labelledby="review-next" class="rounded-xl bg-sand-100 px-4 py-4 dark:bg-[#26241e]">
        <h3 id="review-next" class="text-[0.875rem] font-bold text-forest-950 dark:text-sand-100">What happens after you submit</h3>
        <ol class="mt-2 space-y-1.5 text-[0.8125rem] text-ink-soft dark:text-[#b3ab9b]">
