            ...
            <div class="space-y-6">
                ...
                <section aria-labelledby="quote-summary"
                    ...
                    <dl class="mt-4 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <dt class="text-[0.875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Total quote price</dt>
                        ...
                        <div>
                            <dt class="text-[0.875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Payment terms</dt>
                            <dd class="mt-1 text-[1.125rem] font-semibold text-ink dark:text-[#e4ddcf]">{{ $quote->payment_terms ?: 'Not stated' }}</dd>
                        </div>
                        <div>
                            <dt class="text-[0.875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Validity</dt>
                ...
                <section class="grid gap-6 md:grid-cols-2">
                    <div class="rounded-2xl border border-sand-200 bg-white p-5 dark:border-[#2c2a24] dark:bg-[#1f1d18]">
                        ...
                        <dl class="mt-3 space-y-3 text-[1.0625rem]">
                            ...
                            <div>
                                <dt class="text-[0.875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Currency</dt>
            ...
            <aside class="space-y-4">
                <section class="rounded-2xl border border-sand-200 bg-white p-5 dark:border-[#2c2a24] dark:bg-[#1f1d18]">
                    ...
                    <dl class="mt-4 space-y-3 text-[1.0625rem]">
                        ...
                        <div>
                            <dt class="text-[0.875rem] uppercase tracking-wide text-ink-soft dark:text-[#8f887b]">Total quantity quoted</dt>
                ...
                <section aria-labelledby="quote-actions"
                    ...
                    @if ($actionable)
                        ...
                        <form method="POST" action="{{ $access->link(request(), 'decline', $rfq, $quote) }}"
                            ...
                            <p class="mt-1 text-[0.9375rem] text-ink-soft dark:text-[#8f887b]">Shared with the supplier so they can improve future offers.</p>
                            <button type="submit"
