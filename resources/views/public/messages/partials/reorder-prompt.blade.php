    ...
    <div class="mt-2 rounded-2xl border border-forest-200 bg-white p-4">
                ...
                @foreach ($order->items as $item)
                    <label class="mt-3 block text-[0.75rem] font-semibold text-ink">
                        ...
                        <span class="mt-1 flex items-center gap-2">
                            ...
                            <span class="shrink-0 text-[0.8125rem] text-ink-soft">{{ $item->unit }}</span>
                        </span>
                    </label>
                @endforeach
        ...
        @else
            ...
            <button type="button" wire:click="openReorder({{ $order->getKey() }})"
                    class="mt-3 w-full rounded-xl border border-forest-700 px-3.5 py-2.5 text-[0.875rem] font-semibold text-forest-700 transition hover:bg-forest-50">
                Reorder
            </button>
        @endif
    </div>
