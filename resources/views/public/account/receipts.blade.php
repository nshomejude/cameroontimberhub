                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        @if ($receipt->order?->rfq)
                            <a href="{{ $access->link(request(), 'receipt', $receipt->order->rfq) }}"
                               class="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-sand-300 px-4 py-2 text-[0.8125rem] font-semibold text-ink transition hover:border-forest-400">
