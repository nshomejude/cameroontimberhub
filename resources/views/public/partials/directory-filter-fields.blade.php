@php($field = 'w-full rounded-lg border border-sand-300 bg-sand-50/60 px-3 py-2.5 text-sm text-ink focus:border-forest-500 focus:bg-white focus:ring-2 focus:ring-forest-100 focus:outline-none')
