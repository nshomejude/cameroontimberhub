...
**Phase 0 total: ~34 days** (item 0.1 done at 0 remaining days; 0.1b split out at 8 days, net +3 over the original estimate). Do not compress this. Every day skipped here is repaid with
