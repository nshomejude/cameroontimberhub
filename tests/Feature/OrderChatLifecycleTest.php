...
/* ------------------------------------------------------------------ helpers */
/* olLifecycle() / olScene() / olAdvanceTo() / olCard() live in
   tests/Support/order_lifecycle_helpers.php (loaded via composer
   autoload-dev.files) because CompanyReviewTest reuses them and
   `--parallel` puts the two files in different workers. */
